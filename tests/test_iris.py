...
def get_algo_base_config():
    ...
    # for example iris)
    config.observation.value_planner.planner.modalities.obs.low_dim = [
        "robot0_eef_pos",
        "robot0_eef_quat",
        "robot0_gripper_qpos",
        "object",
    ...
    config.observation.value_planner.planner.modalities.subgoal.low_dim = [
        "robot0_eef_pos",
        "robot0_eef_quat",
        "robot0_gripper_qpos",
        "object",
    ...
    config.observation.value_planner.value.modalities.obs.low_dim = [
        "robot0_eef_pos",
        "robot0_eef_quat",
        "robot0_gripper_qpos",
        "object",
...
def iris_modifier_12(config):
    ...
    config.algo.value_planner.value.critic.value_bounds = [-100.0, 100.0]
    return config
