# robomimic v0.1 (CoRL 2021) Datasets and Experiments

TODO: re-organize and clean this section up, and move some quick examples into Getting Started
...
<p class="admonition-title">Warning: requires specific version of robosuite</p>

When working with the robosuite datasets, please make sure that you have installed [robosuite](https://robosuite.ai/), and that you are on the `offline_study` branch of robosuite.
