    ...
    if args.env == "r2d2":
        ...
        generator.add_param(
            ...
            values=[
                ...
                [{"path": "~/datasets/kitchen/prior/mimicgen/pnp_table_to_cab/viraj_mg_2023-08-10-20-31-14", "filter_key": "100_demos"}],
                [{"path": "~/datasets/kitchen/prior/mimicgen/pnp_table_to_cab/viraj_mg_2023-08-10-20-31-14", "filter_key": "1000_demos"}],
            ],
            value_names=[
                "human-100",
                "mg-100",
