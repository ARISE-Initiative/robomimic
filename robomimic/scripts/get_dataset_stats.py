"""
Helper script to report dataset statistics. By default, will print trajectory length statistics,
...
Example usage:
    ...
    python get_dataset_stats.py --dataset ../../tests/assets/test.hdf5

    # run script only on validation data
    python get_dataset_stats.py --dataset ../../tests/assets/test.hdf5 --filter_key valid
"""
import h5py
import json
import argparse
