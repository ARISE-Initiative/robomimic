...
def register_all_links():
    ...
    # all new machine generated datasets
    for task, horizon in zip(["stack", "two_arm_threading", "two_arm_three_piece_assembly", "two_arm_transport", "two_arm_box_cleanup", "two_arm_drawer_cleanup", "two_arm_lift_tray"], [400, 400, 300, 1200, 500, 550, 500]):
        register_dataset_link(task=task, dataset_type="mg", hdf5_type="image", horizon=horizon,
            link="image.hdf5")
